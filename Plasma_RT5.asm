...
inicio:	li	$t1,2		# Duas tarefas
	...
	sw	$t1,0x0000($gp)	# Armazena o endereço da tarefa 0 no TCB da tarefa 1 (1o endereço)
	
	la	$t1,task2	# Carrega em t1 o endereço da tarefa 2
	sw	$t1,0x0100($gp)	# Armazena o endereço da tarefa 1 no TCB da tarefa 2 (1o endereço)
	
	la	$t1,task3	# Carrega em t1 o endereço da tarefa 3
	sw	$t1,0x0200($gp)	# Armazena o endereço da tarefa 1 no TCB da tarefa 3 (1o endereço)
...
task2:	lui	$gp,0x2000	# lui carrega o valor passado nos 16 msbs do registrador
				# 0x2000 0000 é o endereço base dos periféricos no uP Plasma
task2_loop:	li	$t1,0xFFF
	sw	$t1,0x40($gp)	# GPIO0 <- 0x?????000 (força 0 em todos os 12 lsbs)
	sw	$t1,0x0030($gp)	# GPIO0 <- 0xFFF
...
task3_loop:	li	$t1,0xFFF
	...
	lw	$s1,0x0000($gp)	# $s1 <- Backup PC
	lw	$s2,0x0008($gp)	# $s2 <- Backup $t2
	lw	$s3,0x000C($gp)	# $s3 <- Backup $t3
	lw	$s4,0x0010($gp)	# $s4 <- Backup $t4
	lw	$s5,0x0014($gp)	# $s5 <- Backup $t5
	lw	$s6,0x007C($gp)	# $s6 <- Backup $ra
	...
	lw	$s2,0x0108($gp)	# $s2 <- Backup $t2
	lw	$s3,0x010C($gp)	# $s3 <- Backup $t3
	lw	$s4,0x0110($gp)	# $s4 <- Backup $t4
	lw	$s5,0x0114($gp)	# $s5 <- Backup $t5
	lw	$s6,0x017C($gp)	# $s6 <- Backup $ra
